...
function createWindow() {
  ...
  mainWindow = new require$$1$2.BrowserWindow({
    ...
    webPreferences: {
      ...
      preload: require$$0__namespace.join(require$$1$2.app.getAppPath(), "src/preload/preload.js")
    }
  });
  if (isDev) {
    process.env["ELECTRON_DISABLE_SECURITY_WARNINGS"] = "true";
    const primaryDisplay = require$$1$2.screen.getPrimaryDisplay();
  ...
  const handleQuit = () => {
    const quitting = 0 === require$$1$2.dialog.showMessageBoxSync({
      type: "question",
      buttons: ["Quit", "Cancel"],
      title: "Confirm Quit",
